...
import { StockExchanges, type TStockPosition } from './index';
import { StockExchangeAutocomplete } from './StockExchangeAutocomplete.component';
import { DesktopDatePicker, LocalizationProvider, MobileDatePicker } from '@mui/x-date-pickers';
import { AdapterDateFns } from '@mui/x-date-pickers/AdapterDateFns';
import { StockService } from './Stock.service';

export type TEditStockPositionDrawerPayload = TStockPosition;

export type TEditStockPositionDrawerProps = {
  onClose: () => void;
} & TEntityDrawerState<TEditStockPositionDrawerPayload>;
