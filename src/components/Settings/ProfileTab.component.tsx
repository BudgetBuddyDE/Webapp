              ...
              <form onSubmit={handler.onSubmit}>
                <Grid container spacing={2} rowSpacing={1}>
                  <Grid item xs={12}>
                    ...
                    >
                      {enableInputs ? <UploadProfileAvatar sx={{ width: 88 }} /> : <ProfileAvatar sx={{ width: 88 }} />}
                    </Box>
                  </Grid>

                  <Grid item xs={12} md={12}>
                    <TextField fullWidth disabled id="uuid" name="uuid" label="UUID" value={form.uuid} sx={{ mt: 2 }} />
                  </Grid>
                  <Grid item xs={12} md={12}>
                    <TextField
                      fullWidth
                ...
                <Box display="flex" flexDirection="row" justifyContent="flex-end">
                  {enableInputs ? (
                    ...
                    <Button component={Link} to="/settings/profile/edit" variant="contained" sx={{ mt: 2 }}>
                      Edit
                    </Button>
                  )}
                </Box>
